...
void main() {
  ...
  PostExpectation _mockResquest() => when(httpClient.request(url: anyNamed('url'), method: anyNamed('method'), body: anyNamed('body')));

  void mockHttpData(Map data) => _mockResquest().thenAnswer((_) async => data);
  // void mockHttpData(Map data) => mockResquest().thenReturn(data);

  void mockHttpError(HttpError error) => _mockResquest().thenThrow(error);
